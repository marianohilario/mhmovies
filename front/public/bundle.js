(() => {
    var e = {
            555: (e) => {
                e.exports = function () {
                    const e = document.querySelectorAll(".carousel-item-img"),
                        t = document.querySelector(".play"),
                        n = document.querySelectorAll(".playTrailerBtn"),
                    ...
                    function s({
                        ...
                        const l = document.querySelector(".banner"),
                            u = document.querySelector(".movie-title"),
                            d = document.querySelector(".year"),
                            f = document.querySelector(".rate"),
                            p = document.querySelector(".duration"),
                            h = document.querySelector(".genreTags"),
                            m = document.querySelector(".synopsis");
                        (l.style.background = `url('${a}')`),
                            (l.style.backgroundSize = "cover"),
                            (l.style.backgroundPosition = "center"),
                            (u.src = e),
                            (d.textContent = n),
                            (f.innerHTML = `<i class="fa fa-star" aria-hidden="true"></i> ${r}`),
                            (p.textContent = o),
                            (h.textContent = s),
                            (m.textContent = i),
                            (t.dataset.trailer = c);
                    ...
                    const i = document.querySelector(".carousel");
                    M.Carousel.init(i, { duration: 400 });
                };
            },
            636: (e) => {
                e.exports = function (e) {
                    ...
                    f.classList.add("card-title", "grey-text", "text-darken-4"),
                        (f.textContent = t),
                        d.appendChild(f);
                    const p = document.createElement("div");
                    p.classList.add("card-reveals");
                    ...
                    y.classList.add("year"), (y.textContent = n);
                    const g = document.createElement("span");
                    g.classList.add("rate"),
                        (g.innerHTML = `<i class="fa fa-star" aria-hidden="true"></i>${r}`);
                    ...
                    w.classList.add("genre");
                    const E = document.createElement("span");
                    E.classList.add("genreTags");
                    let S = "";
                    for (let e = 0; e < s.length; e++)
                        (S += s[e]), e !== s.length - 1 && (S += " - ");
                    (E.textContent = S), w.appendChild(E);
                    const O = document.createElement("p");
                    O.classList.add("grey-text", "text-darken-3"),
                        (O.textContent = i);
                    const R = document.createElement("a");
                    R.classList.add("playTrailerBtn");
                    const T = document.createElement("div");
                    return (
                        R.appendChild(T),
                        (R.innerHTML =
                            '<i class="fa fa-play-circle-o" aria-hidden="true"></i> Watch Trailer'),
                        (R.dataset.trailer = c),
                        p.appendChild(h),
                        p.appendChild(m),
                        p.appendChild(w),
            ...
            889: (e) => {
                e.exports = function (e) {
                    ...
                    f.classList.add("carousel-item-img"),
                        (f.src = c),
                        (f.alt = t + " poster"),
                        (f.dataset.title = n),
                        (f.dataset.year = r),
                        (f.dataset.rate = o),
                        (f.dataset.duration = s);
                    let p = "";
                    for (let e = 0; e < i.length; e++)
                        (p += i[e]), e !== i.length - 1 && (p += " - ");
                    return (
                        (f.dataset.genre = p),
                        (f.dataset.synopsis = a),
                        (f.dataset.bg = l),
                        (f.dataset.trailer = u),
                        d.appendChild(f),
                        d
            ...
            742: (e, t, n) => {
                const r = n(636);
                e.exports = function (e) {
                    const t = document.querySelector(".movies-container");
                    e.map((e) => r(e)).forEach((e) => {
                        t.appendChild(e);
                    });
                };
            },
            ...
            90: (e) => {
                e.exports = "http://localhost:3000/movies";
            },
            425: (e, t, n) => {
                "use strict";
                function r(e, t) {
                ...
                const { toString: o } = Object.prototype,
                    ...
                    i =
                        ...
                        (e) => {
                            const t = o.call(e);
                            return (
                                a[t] || (a[t] = t.slice(8, -1).toLowerCase())
                            );
                        });
                var a;
                ...
                const $ = I.toFlatObject(I, {}, null, function (e) {
                ...
                const oe =
                    ...
                    se =
                        ((ie =
                            ...
                            navigator.product),
                        oe &&
                            ["ReactNative", "NativeScript", "NS"].indexOf(ie) <
                                0);
                var ie;
                const ae =
                ...
                function ue(e) {
                    function t(e, n, r, o) {
                        ...
                        const i = Number.isFinite(+s),
                            a = o >= e.length;
                        return (
                            (s = !s && I.isArray(r) ? r.length : s),
                            a
                                ? (I.hasOwnProp(r, s)
                                      ? (r[s] = [r[s], n])
                                      : (r[s] = n),
                                  !i)
                                : ((r[s] && I.isObject(r[s])) || (r[s] = []),
                                  t(e, n, r[s], o) &&
                                      I.isArray(r[s]) &&
                                      (r[s] = (function (e) {
                                          const t = {},
                ...
                class be {
                    ...
                    set(e, t, n) {
                        ...
                        const s = (e, t) => I.forEach(e, (e, n) => o(e, n, t));
                ...
                be.accessor([
                    ...
                    I.reduceDescriptors(be.prototype, ({ value: e }, t) => {
                ...
                const Ae = (e) => (e instanceof we ? { ...e } : e);
                function Le(e, t) {
                    t = t || {};
                    const n = {};
                    function r(e, t, n) {
                ...
                var je = (e) => {
                        ...
                        if (
                            le.hasStandardBrowserEnv &&
                            (o && I.isFunction(o) && (o = o(t)),
                            o || (!1 !== o && ve(t.url)))
                        ) {
                            const e = s && i && Ce.read(i);
                            e && a.set(s, e);
                        }
                        return t;
                    },
                            ...
                            return new Promise(function (t, n) {
                                ...
                                l.open(r.method.toUpperCase(), r.url, !0),
                                    ...
                                    "setRequestHeader" in l &&
                                        I.forEach(s.toJSON(), function (e, t) {
                ...
                const _e = function* (e, t) {
                    ...
                    Ue = (e, t) => {
                        ...
                        return (r) =>
                            setTimeout(() =>
                                t({ lengthComputable: n, total: e, loaded: r })
                            );
                    },
                    Be =
                    ...
                    ke = Be && "function" == typeof ReadableStream,
                    De =
                        Be &&
                ...
                const Me =
                    ...
                    Ie =
                        ...
                        !!(() => {
                            try {
                                return I.isReadableStream(
                                    new Response("").body
                                );
                            } catch (e) {}
                        })(),
                    ze = { stream: Ie && ((e) => e.body) };
                var He;
                Be &&
                    ((He = new Response()),
                    [
                    ...
                    fetch:
                        ...
                        (async (e) => {
                            ...
                            try {
                                ...
                                l = l || "text";
                                let i = await ze[I.findKey(ze, l) || "text"](
                                    o,
                                    e
                                );
                                return (
                ...
                const We = (e) => `- ${e}`,
                    Ke = (e) => I.isFunction(e) || null === e || !1 === e;
                var Ve = (e) => {
                    e = I.isArray(e) ? e : [e];
                    const { length: t } = e;
                    let n, r;
                ...
                function Ge(e) {
                    return (
                        ...
                        Ve(e.adapter || fe.adapter)(e).then(
                            function (t) {
                                return (
                                    $e(e),
                                    (t.data = Ee.call(
                ...
                class et {
                    ...
                    _request(e, t) {
                        ...
                        void 0 !== n &&
                            Ze.assertOptions(
                                n,
                                {
                                    silentJSONParsing: Ye.transitional(
                                        Ye.boolean
                                    ),
                                    forcedJSONParsing: Ye.transitional(
                                        Ye.boolean
                                    ),
                                    clarifyTimeoutError: Ye.transitional(
                                        Ye.boolean
                                    ),
                                },
                                !1
                        ...
                        let s = o && I.merge(o.common, o[t.method]);
                        o &&
                            I.forEach(
                                [
                                    "delete",
                    ...
                    getUri(e) {
                        return ee(
                            xe((e = Le(this.defaults, e)).baseURL, e.url),
                            e.params,
                            e.paramsSerializer
                        );
                    }
                ...
                class nt {
                    constructor(e) {
                        ...
                        this.promise.then((e) => {
                            ...
                            e(function (e, r, o) {
                                n.reason ||
                                    ((n.reason = new Oe(e, r, o)), t(n.reason));
                            });
                    }
                    throwIfRequested() {
                ...
                const it = (function e(t) {
                    ...
                    return (
                        I.extend(o, tt.prototype, n, { allOwnKeys: !0 }),
                        I.extend(o, n, null, { allOwnKeys: !0 }),
                        (o.create = function (n) {
                            return e(Le(t, n));
                        }),
                        o
                ...
                (it.Axios = tt),
                    ...
                    (it.AxiosHeaders = we),
                    (it.formToJSON = (e) =>
                        ue(I.isHTMLForm(e) ? new FormData(e) : e)),
                    (it.getAdapter = Ve),
                    (it.HttpStatusCode = st),
                    (it.default = it),
                    (e.exports = it);
            },
        },
    ...
    (n.g = (function () {
        ...
        (() => {
            ...
            (async () => {
                try {
                    const { data: n } = await s.get(e);
                    r(n);
                    const i =
                        n.length > 5
                            ? n.sort((e, t) => t.rate - e.rate).slice(0, 5)
                            : n.sort((e, t) => t.rate - e.rate);
                    o(i), t();
                } catch (e) {
